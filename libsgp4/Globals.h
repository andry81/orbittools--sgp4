...
const double kMU = double(3986008) / 1e1;
const double kXKMPER = double(63781370) / 1e4; //6378.135;
const double kXJ2 = double(10826158) / 1e10; //1.082616e-3;
const double kXJ3 = double(-253881) / 1e11;
const double kXJ4 = double(-165597) / 1e11;
...
const double kTHDT = double(437526908801129966) / 1e10 / 1e10;
/*
 * earth flattening
 */
const double kF = (double(63781370) - 63567523) / 63781370; //1.0 / 298.26;
/*
 * earth rotation per sideral day
 */
const double kOMEGA_E = double(100273790934) / 1e11;
const double kAU = double(149597870691) / 1e3;
